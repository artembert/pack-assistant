...
export type GetTripsQuery = { __typename?: 'Query', trips: Array<{ __typename?: 'Trip', id: string, name: string, destination: string, type: string, startDate?: string | null, endDate?: string | null, createdAt: string, updatedAt: string, itemGroups: Array<{ __typename?: 'ItemGroup', id: string, name: string, packedCount: number, totalCount: number }> }> };
